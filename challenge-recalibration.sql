...
-- New: 8%/5%/4%, 6% static dd, 3% daily, phase-specific risk caps,
-- 15 min trades and
...
values
 ('trad_10k_p1','traditional',1,'10K Challenge - Phase 1',  10000,129, 8,6,3,'static',5,15,.75,NULL,NULL,NULL,true,85,'trad_10k_p2'),
 ('trad_10k_p2','traditional',2,'10K Challenge - Phase 2',  10000,  0, 5,6,3,'static',5,15,.50,NULL,NULL,NULL,true,85,'trad_10k_p3'),
 ('trad_10k_p3','traditional',3,'10K Challenge - Phase 3',  10000,  0, 4,6,3,'static',5,15,.40,NULL,NULL,NULL,true,85,NULL),

 ('trad_25k_p1','traditional',1,'25K Challenge - Phase 1',  25000,199, 8,6,3,'static',5,15,.75,NULL,NULL,NULL,true,85,'trad_25k_p2'),
 ('trad_25k_p2','traditional',2,'25K Challenge - Phase 2',  25000,  0, 5,6,3,'static',5,15,.50,NULL,NULL,NULL,true,85,'trad_25k_p3'),
 ('trad_25k_p3','traditional',3,'25K Challenge - Phase 3',  25000,  0, 4,6,3,'static',5,15,.40,NULL,NULL,NULL,true,85,NULL),

 ('trad_50k_p1','traditional',1,'50K Challenge - Phase 1',  50000,299, 8,6,3,'static',5,15,.75,NULL,NULL,NULL,true,85,'trad_50k_p2'),
 ('trad_50k_p2','traditional',2,'50K Challenge - Phase 2',  50000,  0, 5,6,3,'static',5,15,.50,NULL,NULL,NULL,true,85,'trad_50k_p3'),
 ('trad_50k_p3','traditional',3,'50K Challenge - Phase 3',  50000,  0, 4,6,3,'static',5,15,.40,NULL,NULL,NULL,true,85,NULL),

 ('trad_100k_p1','traditional',1,'100K Challenge - Phase 1',100000,449,8,6,3,'static',5,15,.75,NULL,NULL,NULL,true,85,'trad_100k_p2'),
 ('trad_100k_p2','traditional',2,'100K Challenge - Phase 2',100000,  0,5,6,3,'static',5,15,.50,NULL,NULL,NULL,true,85,'trad_100k_p3'),
 ('trad_100k_p3','traditional',3,'100K Challenge - Phase 3',100000,  0,4,6,3,'static',5,15,.40,NULL,NULL,NULL,true,85,NULL),

 ('trad_200k_p1','traditional',1,'200K Challenge - Phase 1',200000,799,8,6,3,'static',5,15,.75,NULL,NULL,NULL,true,85,'trad_200k_p2'),
 ('trad_200k_p2','traditional',2,'200K Challenge - Phase 2',200000,  0,5,6,3,'static',5,15,.50,NULL,NULL,NULL,true,85,'trad_200k_p3'),
 ('trad_200k_p3','traditional',3,'200K Challenge - Phase 3',200000,  0,4,6,3,'static',5,15,.40,NULL,NULL,NULL,true,85,NULL),
...
-- intraday drawdown / 4% daily / 0.70% risk-per-trade / 20 min trades —
...
-- independent hard-to-clear conditions on the same stage.
 ('infinity_s1','infinity',1,'Infinity Stage 1 - Evaluation',  1000,  0, 7,8,4,'trailing_intraday', 6,20,.70,3,NULL,3,true, 0,'infinity_s2'),
 ('infinity_s2','infinity',2,'Infinity Stage 2 - Funded Sim',  5000,  0, 7,8,4,'trailing_intraday',10,20,.70,NULL,55,NULL,true,85,'infinity_s3'),
 ('infinity_s3','infinity',3,'Infinity Stage 3 - Qualification',10000,0, 7,8,4,'trailing_intraday',10,20,.70,NULL,NULL,NULL,true,85,'infinity_s4'),
 ('infinity_s4','infinity',4,'Infinity Stage 4 - Professional',25000, 0, 0,8,4,'trailing_eod',      0, 0,.50,NULL,NULL,NULL,true,85,NULL),
...
-- the gauntlet twice.
 ('fut_25k_p1','futures',1,'25K Futures - Phase 1',  25000,129,6,4,2,'trailing_eod',6,30,.50,NULL,NULL,NULL,true,85,'fut_25k_p2'),
 ('fut_25k_p2','futures',2,'25K Futures - Phase 2',  25000,  0,4,4,2,'trailing_eod',6,30,.40,NULL,NULL,NULL,true,85,NULL),
 ('fut_50k_p1','futures',1,'50K Futures - Phase 1',  50000,179,6,4,2,'trailing_eod',6,30,.50,NULL,NULL,NULL,true,85,'fut_50k_p2'),
 ('fut_50k_p2','futures',2,'50K Futures - Phase 2',  50000,  0,4,4,2,'trailing_eod',6,30,.40,NULL,NULL,NULL,true,85,NULL),
 ('fut_100k_p1','futures',1,'100K Futures - Phase 1',100000,329,6,4,2,'trailing_eod',6,30,.50,NULL,NULL,NULL,true,85,'fut_100k_p2'),
 ('fut_100k_p2','futures',2,'100K Futures - Phase 2',100000,  0,4,4,2,'trailing_eod',6,30,.40,NULL,NULL,NULL,true,85,NULL),
 ('fut_150k_p1','futures',1,'150K Futures - Phase 1',150000,479,6,4,2,'trailing_eod',6,30,.50,NULL,NULL,NULL,true,85,'fut_150k_p2'),
 ('fut_150k_p2','futures',2,'150K Futures - Phase 2',150000,  0,4,4,2,'trailing_eod',6,30,.40,NULL,NULL,NULL,true,85,NULL)
