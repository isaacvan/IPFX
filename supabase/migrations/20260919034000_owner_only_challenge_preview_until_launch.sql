-- Keep every challenge application private until the public launch.
-- The website gate is only presentation; this RPC check is the authority.
begin;
...
begin
  ...
  if current_timestamp < timestamptz '2026-10-01 00:00:00 Europe/London'
     and not exists(
       select 1
       from auth.users u
    ...
    raise exception 'CHALLENGES_LAUNCH_OCTOBER_1' using errcode='42501';
  end if;
