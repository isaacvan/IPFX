(function () {
  ...
  const RELEASES = {
    windows: {
      sourceName: 'IPFX-Markets-UNSIGNED-PREVIEW-0.1.0-preview.1-win-x64.exe',
      filename: 'IPFX-Markets-0.1.0-preview.1-Windows-x64.exe',
      contentType: 'application/vnd.microsoft.portable-executable',
      label: 'Download Windows preview'
    },
    'mac-arm64': {
      sourceName: 'IPFX-Markets-UNSIGNED-PREVIEW-0.1.0-preview.1-mac-arm64.dmg',
      filename: 'IPFX-Markets-0.1.0-preview.1-Apple-Silicon.dmg',
      contentType: 'application/x-apple-diskimage',
      label: 'Download Apple Silicon preview'
    },
    'mac-x64': {
      sourceName: 'IPFX-Markets-UNSIGNED-PREVIEW-0.1.0-preview.1-mac-x64.dmg',
